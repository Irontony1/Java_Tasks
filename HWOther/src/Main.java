...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] arrayCheck = {2, 5, 2, 0, 0, 8};
        //System.out.println(ArraysMetod.countEvents(arrayCheck));

        //System.out.println(ArraysMetod.differenceMaxMin(arrayCheck));

        System.out.println(ArraysMetod.isCoupleZero(arrayCheck));
    }
}
